...
import { Calendar, DollarSign, FileText, LayoutDashboard, LogOut, PanelLeft, Users } from "lucide-react";
...
export default function DashboardLayout({
  ...
  // If OAuth is not configured (no loginUrl), skip authentication check and render directly
  if (!user && loginUrl) {
    return (
